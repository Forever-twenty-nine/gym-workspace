...
export class EntrenadosPage {
  ...
  async saveNotificacionChanges() {
    ...
    try {
      ...
      this.toastService.log(`Notificación ${this.isNotificacionCreating() ? 'creada' : 'actualizada'}: ${updatedData.titulo}`);
      this.closeNotificacionModal();
    } catch (error: any) {
      console.error('Error al guardar:', error);
      this.toastService.log(`ERROR al guardar notificación: ${error.message}`);
    } finally {
      this.isLoading.set(false);
    }
  }
  ...
  async deleteNotificacion(id: string) {
    try {
      ...
      this.toastService.log('Notificación eliminada: ' + id);
    } catch (error) {
      this.toastService.log('Error al eliminar notificación');
    }
  }
  ...
  async deleteMensaje(id: string) {
    try {
      ...
      this.toastService.log('Mensaje eliminado: ' + id);
    } catch (error) {
  ...
  async saveInvitacionChanges() {
    ...
    try {
      ...
      this.toastService.log(`Invitación ${this.isInvitacionCreating() ? 'creada' : 'actualizada'}`);
      this.closeInvitacionModal();
    } catch (error: any) {
      console.error('Error al guardar:', error);
      this.toastService.log(`ERROR al guardar invitación: ${error.message}`);
    } finally {
      this.isLoading.set(false);
    }
  }
  ...
  async deleteInvitacion(id: string) {
    try {
      ...
      this.toastService.log('Invitación eliminada: ' + id);
    } catch (error) {
  ...
  async aceptarInvitacion(id: string) {
    try {
      ...
      this.toastService.log('Invitación aceptada: ' + id);
    } catch (error) {
  ...
  async rechazarInvitacion(id: string) {
    try {
      ...
      this.toastService.log('Invitación rechazada: ' + id);
    } catch (error) {
