...
import { IonHeader, IonToolbar, IonTitle, IonMenuButton, IonButtons, IonIcon, IonBadge } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonTitle, IonHeader, IonToolbar, IonMenuButton, IonButtons, IonIcon, IonBadge],
